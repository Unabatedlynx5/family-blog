/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6f8850071333efa11b7f3e2ee6fc322)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ENVIRONMENT: string;
		GLOBAL_CHAT: DurableObjectNamespace /* GlobalChat from family-blog-chat */;
		POST_ROOM: DurableObjectNamespace /* PostRoom from family-blog-chat */;
		MEDIA: R2Bucket;
		DB: D1Database;
		EMAIL: SendEmail;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "ADMIN_API_KEY" | "ENVIRONMENT">> {}
}
